...
Exciting messages usually have a few things in common, but the main thing is: it is easy for them to process, to understand, creates clarity and is easily actionable.

### Mental Energy Used For Replying
...
### Mental Energy Used For Questions
...
❌ Why did you go running today? → Requires 10 mana
...
### Getting Reviews On Your Work

Getting review should be done elegantly.
...
✅ If you send 200 lines of code change and tag them in the 10 lines of the code "can you review these lines" -> That's better  
✅ If you create a separate PR with only the 10 lines of code "can you review this PR" -> They'll love you

#### Example: Making Plans With Friends
...
Check out [communication](/communication) for more principles.  
